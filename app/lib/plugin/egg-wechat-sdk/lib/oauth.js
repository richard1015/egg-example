...
/**
 * 根据appid secret，换取access token
 * 获取openid之后，可以调用`wechat.API`来获取更多信息
 * Examples:
 * ```
 * api.getJSAccessToken(callback);
 * ```
 * Callback:
 *
 ...
 * @param {Function} callback 回调函数
 */
OAuth.prototype.getJSAccessToken = function (callback) {
  // public static string Mchid = "1382891802"; //mchid
  // public static string AppId = "wxb9cf823d36656452"; //appid
  // public static string Appsecret = "c9e66467fbea626f685f42a409fe1d46"; //appsecret
  // public static string Appkey = "phUBzgLUnqx6pvP9GiXkP2HNxEE42aKW"; //appkey 
 ...
 * @param {Function} callback 回调函数
 */
OAuth.prototype.getTicket = function (access_token,callback) {
  var url = 'api.weixin.qq.com/cgi-bin/ticket/getticket';
  var info = {
    access_token,
    type: 'jsapi'
  };
